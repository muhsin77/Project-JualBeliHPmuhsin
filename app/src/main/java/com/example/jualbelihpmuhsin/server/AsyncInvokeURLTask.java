package com.example.jualbelihpmuhsin.server;
...
public class AsyncInvokeURLTask extends AsyncTask<Void, Void, String> {
    public String mNoteItWebUrl = "http://192.168.43.74/xphone/";
    ...
    public String url_server ="http://siakad-altie.000webhostapp.com/xphone/";
